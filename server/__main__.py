...
def parse_args():
    ...
    ap.add_argument("--admin-names", default=None)
    ap.add_argument("--site-url", default=None)
    ap.add_argument("--difficulty", default=None)
    ap.add_argument("--state-path", default=None)
    ap.add_argument("--payment-card", default=None)
    ap.add_argument("--payment-card-holder", default=None)
    ap.add_argument("--payment-note", default=None)
